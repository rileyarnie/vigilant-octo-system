        ...
        <>
            ...
            <Modal
                ...
                <Modal.Header closeButton>
                    <Modal.Title id="contained-modal-title-vcenter">Application Id: {applicationId}{' '}
                        {
                            isAdmitted === 'APPROVED' ?
                                <Link to={'/publishedsemesters'}
                                    onClick={() => localStorage.setItem('programId', programCohortId)}>
                                    <Button variant="info" onClick={handleClose}>Semesters</Button>
                                </Link>
                                :
                                <>
                    ...
                    <ValidationForm>
                        <div className="form-group row">
                            ...
                            <div className="col-md-6">
                                ...
                                <TextInput name='lastName' id='lastName' type='text' placeholder="Enter Last name" required defaultValue={lastName}
                        ...
                        <div className="form-group row">
                            <div className="col-md-6">
                                ...
                                <TextInput name='otherName' id='otherName' type='text' placeholder="Enter other name" defaultValue={otherName}
                                    onChange={(e) => { setOtherName(e.target.value); }}/>
                            </div>
                            <div className="col-md-6">
                                <label htmlFor='nationality'><b>Nationality</b></label><br/><br/>
                                <TextInput name='nationality' id='nationality' placeholder=" Kenyan" required  defaultValue={nationality} onChange={(e) => {
                        ...
                        <div className="form-group row">
                            <div className="col-md-6">
                                ...
                                <TextInput name='identification' id='identification' placeholder=" 346678798" defaultValue={identification} required onChange={(e) => {
                                    setIdentification(e.target.value);
                                }} type='text'/>
                            </div>
                            <div className="col-md-6">
                                <label htmlFor='gender'><b>Gender</b></label><br/><br/>
                                <SelectGroup name="gender" id="gender" defaultValue={gender} onChange={(e) => {
                        ...
                        <div className="form-group row">
                            <div className="col-md-6">
                                ...
                                <SelectGroup name="maritalStatus" id="maritalStatus" defaultValue={maritalStatus} onChange={(e) => {
                            ...
                            <div className="col-md-6">
                                ...
                                <SelectGroup name="religion" id="religion" required defaultValue={religion} onChange={(e) => {
                        ...
                        <div className="form-group row">
                            <div className="col-md-6">
                                ...
                                <TextInput name='dateOfBirth' id='dateOfBirth' required defaultValue={dateOfBirth} onChange={(e: { target: { value: React.SetStateAction<string>; }; }) => { setDateOfBirth(e.target.value); }} type='date'/>
                            </div>
                            <div className="col-md-6">
                                <label htmlFor='placeofBirth'><b>Place of Birth</b></label><br/><br/>
                                <TextInput name='placeofBirth' id='placeofBirth' required defaultValue={placeofBirth} onChange={(e) => { setPlaceOfBirth(e.target.value); }} type='text'/>
                            </div>
                        </div>
                        <div className="form-group row">
                            <div className="col-md-6">
                                <label htmlFor='phoneNumber'><b>Phone Number</b></label><br/><br/>
                                <TextInput name='phoneNumber' id='phoneNumber' defaultValue={phoneNumber} required onChange={(e) => { setPhoneNumber(e.target.value); }} placeholder="+254 712 345 789" type='text'/>
                            </div>
                            <div className="col-md-6">
                                <label htmlFor='emailAddress'><b>Email Address</b></label><br/><br/>
                                <TextInput name='emailAddress' id='emailAddress' required defaultValue={emailAddress} onChange={(e) => { setEmailAddress(e.target.value); }} placeholder="Enter email address" type='email'/>
                            </div>
                        </div>
                        <br/><br/><br/><br/>
                        ...
                        <div className="form-group row">
                            <div className="col-md-4">
                                ...
                                <TextInput name='name' placeholder="Enter name" id='name' defaultValue={nextOfKinName} onChange={(e) => { setNextOfKinName(e.target.value); }} type='text'/>
                            </div>
                            <div className="col-md-4">
                                <label htmlFor='phoneNumber'><b>Phone Number</b></label><br/><br/>
                                <TextInput name='phoneNumber' placeholder="Enter phone number" id='phoneNumber' defaultValue={nextOfKinPhoneNumber} onChange={(e) => { setNextOfKinPhoneNumber(e.target.value); }} type='text'/>
                            </div>
                            <div className="col-md-4">
                                <label htmlFor='relation'><b>Relation</b></label><br/><br/>
                                <TextInput name='relation' placeholder="Relation" id='relation' defaultValue={nextOfKinRelation} onChange={(e) => {
                        ...
                        <div className="form-group row">
                            <div className="col-md-6">
                                ...
                                <TextInput name='physicalChallenges' multiline rows="3" defaultValue={physicalChallenges} id='physicalChallenges' onChange={(e) => { setPhysicalChallenges(e.target.value); }} type='text'/>
                            </div>
                            <div className="col-md-6">
                                <label htmlFor='courseStartDate'><b>Course Start Date</b></label><br/><br/>
                                <TextInput name='courseStartDate' required id='courseStartDate' defaultValue={courseStartDate} onChange={(e) => { setCourseStartDate(e.target.value); }} type='date'/>
                            </div>
                        </div>
                        <div className="form-group row">
                            <div className="col-md-6">
                                <label htmlFor='campus'><b>Campus</b></label><br/><br/>
                                <SelectGroup name="campus" id="campus" onChange={(e) => { setCampus(e.target.value); }} defaultValue={campus} required errorMessage="Please select campus">
                                    <option value="">- Please select -</option>
                                    {campuses.map((camp) => {
                            ...
                            <div className="col-md-6">
                                ...
                                <TextInput name='sponsor' placeholder="Sponsor name" id='sponsor' defaultValue={sponsor} required onChange={(e) => { setSponsor(e.target.value); }} type='text'/>
                            </div>
                        </div>
                        <div className="form-group row">
                            <div className="col-md-6">
