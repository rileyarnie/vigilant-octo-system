...
export const DeactivateCourseCohort = (props: IProps): JSX.Element => {
    ...
    return (
        <>
            {props.selectedRow.s_name ? (
                <Button variant={className} onClick={() => setShowModal(true)}>
                    {action}
                </Button>
            ) : null}

            <Modal {...props} size="lg" aria-labelledby="contained-modal-title-vcenter" centered show={showModal}>
                <Modal.Header>
                ...
                <Modal.Footer>
                    <Col>
                        <Button variant="danger" className="float-left" onClick={() => setShowModal(false)}>
                            Cancel
                        </Button>
                        <Button variant="info" className="float-right" onClick={() => handleToggleCourseCohortActivation()}>
                            {action}
                        </Button>
                    </Col>
                </Modal.Footer>
