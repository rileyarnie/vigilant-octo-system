...
class NavContent extends Component<INavContentProps, NavContentState> {
    ...
    scrollPrevHandler = () => {
        ...
        const scrollWidth = this.state.scrollWidth - wrapperWidth;
        if (scrollWidth < 0) {
        ...
        if (this.props.layout === 'horizontal') {
            ...
            mainContent = (
                <div className="navbar-content sidenav-horizontal" id="layout-sidenav">
                    <a href={SYS.BLANK_LINK} className={prevClass.join(' ')} onClick={this.scrollPrevHandler}>
                        <span />
                    </a>
                    ...
                    <a href={SYS.BLANK_LINK} className={nextClass.join(' ')} onClick={this.scrollNextHandler}>
                        <span />
                    </a>
                </div>
            );
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(windowSize(NavContent as any))) as any;
